...
namespace practice0CSharp
{
    public partial class Main : Form, IMyInterface
    {
        ...
        {
            if (textBox1.Text != "" && comboBox1.Text != "변수")
                box.Items.Add(textBox1.Text);
            if (textBox2.Text != "" && comboBox2.Text != "변수")
                box.Items.Add(textBox2.Text);
            if (textBox3.Text != "" && comboBox3.Text != "변수")
                box.Items.Add(textBox3.Text);
            if (textBox4.Text != "" && comboBox4.Text != "변수")
                box.Items.Add(textBox4.Text);
            if (textBox5.Text != "" && comboBox5.Text != "변수")
                box.Items.Add(textBox5.Text);
            if (textBox6.Text != "" && comboBox6.Text != "변수")
                box.Items.Add(textBox6.Text);
            if (textBox7.Text != "" && comboBox7.Text != "변수")
                box.Items.Add(textBox7.Text);
            if (textBox8.Text != "" && comboBox8.Text != "변수")
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            //Naming Rull Null Check
            if (isNamingNull())
            {
                MessageBox.Show("Naming Rull에 빈칸이 있습니다!");
                return;
            }
        ...
        {
            if (!(dateTimePicker1.Value.Year <= int.Parse(dd[0]) && dateTimePicker1.Value.Month <= int.Parse(dd[1]) && dateTimePicker1.Value.Day <= int.Parse(dd[2])))
            {
                overTime = true;
                return false;
            }
            else
                if (dateTimePicker2.Value.Year >= int.Parse(dd[0]) && dateTimePicker2.Value.Month >= int.Parse(dd[1]) && dateTimePicker2.Value.Day >= int.Parse(dd[2]))
                    return true;
            return false;
        }
        ...
        {
            string responseFromServer = "";
            HttpWebRequest Hwr2 = (HttpWebRequest)WebRequest.Create("http://cafe.naver.com/ArticleList.nhn?search.clubid=27874272");
            Hwr2.Method = "GET";
        ...
        private void spaceIgnore_CheckedChanged(object sender, EventArgs e)
        {
