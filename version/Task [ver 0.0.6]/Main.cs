...
namespace practice0CSharp
{
    public partial class Main : Form, IMyInterface
    {
        ...
        /* Read Templet form Saved Text */
        private void readTemplet()
        {
        ...
        /* Open Templet Clicked */
        private void OpenTemplet_Click(object sender, EventArgs e)
        {
            opfile.ShowDialog();
