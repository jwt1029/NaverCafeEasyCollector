    ...
    class NLoginCLS
    {
        ...
        public bool Login(string id, string pw)
        {
            ...
            if (Result.Contains("location.replace"))
            {
                ...
                /*Cafe
                HttpWebRequest Hwr2 = (HttpWebRequest)WebRequest.Create("http://cafe.naver.com/ArticleRead.nhn?clubid=27874272&articleid=2441");
                Hwr2.Method = "GET";

                //string POSTFormatString2 = "club=27874272&articleid=2441";
                Hwr2.CookieContainer = new CookieContainer();
                Hwr2.CookieContainer.Add(wres.Cookies);
